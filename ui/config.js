...
const appConfig = merge({}, config, {
  entry: [...(WATCH ? ['webpack-hot-middleware/client'] : []), 'babel-polyfill', './src/index.js'],
  output: {
  ...
  plugins: [
    ...
    ...(!DEBUG
      ...
      : []),
    ...(WATCH ? [new webpack.HotModuleReplacementPlugin(), new webpack.NoErrorsPlugin()] : [])
  ],
  module: {
    loaders: [
...
const serverConfig = merge({}, config, {
  ...
  module: {
    loaders: [JS_LOADER, ...config.module.loaders]
  },
